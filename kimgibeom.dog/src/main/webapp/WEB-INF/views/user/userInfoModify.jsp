...
<style>
	...
	.member table .text input{height:30px; width:40%;}
	...
	.member table tr input{margin:7px 0;}
	...
	.msg{color:red; display:none; margin-bottom:7px; font-size:14px !important;}
	
	@media screen and (max-width:935px){
		.member table .text input{width:100%}
		.member table tr:nth-child(1) input{margin-bottom:0;}
		.msg{font-size:12px !important; margin-top:5px;}
	}
					...
					<form action="#">
						...
						<table>
							...
							<tr class="text tableH">
								<th>비밀번호</th>
								<td>
									<input id='pw' type='password'/><span> 8~16글자, 영문, 숫자, 특수문자(1개 이상)</span>
									<br>
							...
							<tr class="number">
								<th>전화번호</th>
								<td>
									<input id='tell' type='number' maxlength='3' oninput="numberMaxLength(this);" value=''/> - <input id='tell2' type='number' maxlength='4' oninput="numberMaxLength(this);" value=''/> - <input id='tell3' type='number' maxlength='4' oninput="numberMaxLength(this);" value=''/>
									<br>
									<span id='tellMsg' class='msg'></span>
								</td>
							</tr>
							<tr class="text">
								<th>E-mail</th>
								<td>
									<input id='email' type="email" value='${user.userEmail}'/>
									<br>
						...
						<div class="button">
							...
							<input type='button' class="no" onClick="location.href='<c:url value="/user/mypage"/>'" value='취소'>
						</div>
					</form>
				</div>
			</div>
